...
function display(star, rating, modName = '') {
  const classes = modName ? `rating__star ${modName}` : 'rating__star';
...
const StarRating = (props) => {
  ...
  useEffect(() => {}, [currentRating, displayRating]);
